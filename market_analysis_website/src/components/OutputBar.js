...
export const OutputBar = () => {  
    ...
    try {
        ...
        const percentageOfOnes = (countOfOnes / total) * 100;
        const percentageOfZeros = (countOfZeros / total) * 100;
        ...
        <div className = "input-container">
          ...
          <div className="graph-container"> {/* Apply container styles */}
            <PieChart className="pie-chart" width={400} height={400}> {/* Apply chart styles */}
                ...
                <Pie data={pieChartData} dataKey="value" outerRadius={150} label fill="#8884d8">
